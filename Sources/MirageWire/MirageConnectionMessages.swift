//
//  MirageConnectionMessages.swift
//  MirageWire
//
...
package struct MirageSessionBootstrapRequest: Codable {
    ...
    /// Structured client capabilities for feature and media-family negotiation.
    package let clientCapabilities: MirageRuntimeCapabilities?
    ...
    package init(
        ...
        clientCapabilities: MirageRuntimeCapabilities? = nil
    ) {
    ...
    package init(from decoder: Decoder) throws {
        ...
        clientCapabilities = try container.decodeIfPresent(
            MirageRuntimeCapabilities.self,
...
package struct MirageSessionBootstrapResponse: Codable {
    ...
    /// Structured host capabilities for feature and media-family negotiation.
    package let hostCapabilities: MirageRuntimeCapabilities?
    ...
    package init(
        ...
        hostCapabilities: MirageRuntimeCapabilities? = nil,
