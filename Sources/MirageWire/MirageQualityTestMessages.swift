//
//  MirageQualityTestMessages.swift
//  MirageWire
//
...
package struct QualityTestRequestMessage: Codable {
    ...
    package let plan: MirageDiagnostics.MirageQualityTestPlan
...
package struct QualityTestBenchmarkMessage: Codable {
    ...
    package let hostCaptureCapability: MirageDiagnostics.MirageHostCaptureCapability?

    /// Creates a quality-test benchmark payload.
    package init(
        testID: UUID,
        encodeMs: Double?,
        hostCaptureCapability: MirageDiagnostics.MirageHostCaptureCapability? = nil
    ) {
        self.testID = testID
...
package struct QualityTestStageCompleteMessage: Codable {
    ...
    package let probeKind: MirageDiagnostics.MirageQualityTestPlan.ProbeKind
