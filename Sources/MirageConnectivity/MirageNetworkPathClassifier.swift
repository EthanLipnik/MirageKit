...
package struct MirageNetworkPathSnapshot: Sendable, Equatable {
    package let kind: MirageCore.MirageNetworkPathKind
...
package enum MirageNetworkPathClassifier {
    ...
    package static func classify(
        ...
        let kind: MirageCore.MirageNetworkPathKind
        ...
        let mediaProfile = MirageMedia.MirageMediaPathProfile.classify(
            pathKind: kind,
