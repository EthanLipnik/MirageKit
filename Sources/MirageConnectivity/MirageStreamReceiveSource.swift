...
#if os(macOS)
/// Adapts an async byte stream to the Network receive callback shape used by host receive loops.
package final class MirageStreamReceiveSource: @unchecked Sendable {
    ...
    package init(stream: AsyncStream<Data>) {
        Task {
