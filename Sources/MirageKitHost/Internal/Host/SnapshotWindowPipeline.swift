    ...
    func apply(
        ...
        if shouldApplyFrameRate(
            ...
            do {
                ...
                MirageLogger.error(.host, error: error, message: "Failed to apply passive snapshot frame rate: ")
            }
        }
        ...
        if let targetBitrateBps,
           shouldApplyBitrate(
            ...
            do {
                ...
                MirageLogger.error(.host, error: error, message: "Failed to apply passive snapshot bitrate: ")
            }
        }
