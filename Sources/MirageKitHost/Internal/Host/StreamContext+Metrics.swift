    ...
    func logStreamStatsIfNeeded() async {
        ...
        if let metricsUpdateHandler, lastStreamStatsLogTime > 0 {
            ...
            let message = MirageWire.StreamMetricsMessage(
                ...
                highRefreshPacingSkips: highRefreshPacingSkippedIntervalCount,
                highRefreshPacingMode: highRefreshFrameAdmissionState.mode.rawValue,
                ...
                mediaMaxPacketSize: mediaMaxPacketSize,
                mediaSendProfile: mediaSendProfileRawValue,
                mosaicTilePlan: latestMosaicTilePlan,
                mosaicEpochSummary: latestMosaicDirtyTileSummary,
