...
public final class MirageHostService {
    ...
    public var hostCaptureCapabilityProvider: (@MainActor @Sendable () -> MirageDiagnostics.MirageHostCaptureCapability?)?
    ...
    /// Media streams opened for active quality tests by client.
    var qualityTestStreamsByClientID: [UUID: any MirageQueuedUnreliableMediaStream] = [:]
