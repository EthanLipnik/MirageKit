...
extension MirageHostService {
    ...
    private func updatePendingAppListRequest(
        ...
        let normalizedKnownIconBundleIdentifiers = Self.normalizedBundleIdentifierList(knownIconBundleIdentifiers)
    ...
    private func sendAppListProgressBatch(
    ...
    private func appListProgressApp(
    ...
    private static func metadataOnlyApp(_ app: MirageInstalledApp) -> MirageInstalledApp {
        MirageInstalledApp(
            bundleIdentifier: app.bundleIdentifier,
            name: app.name,
            path: app.path,
