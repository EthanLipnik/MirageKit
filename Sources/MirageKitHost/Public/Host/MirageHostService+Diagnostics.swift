...
public extension MirageHostService {
    var networkDiagnosticsSummaryLines: [String] {
        ...
        return [
            ...
            "Host Requested Direct Ports: tcp=\(loomNode.configuration.controlPort) udp=\(loomNode.configuration.udpPort) quic=\(loomNode.configuration.quicPort)",
            "Host Default Direct Ports: tcp=\(MirageKit.directTCPPort) udp=\(MirageKit.directUDPPort) quic=\(MirageKit.directQUICPort)",
