...
struct MirageDiagnosticsTests {
    ...
    func hostCaptureCapabilityPixelCountsAvoidIntegerOverflow() throws {
        let measuredAt = Date(timeIntervalSince1970: 0)
        ...
        let decoded = try JSONDecoder().decode(
            MirageDiagnostics.MirageHostCaptureCapability.self,
