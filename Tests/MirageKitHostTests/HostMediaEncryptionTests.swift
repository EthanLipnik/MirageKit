//
//  HostMediaEncryptionTests.swift
//  MirageKit
//
//  Created by Ethan Lipnik on 2/21/26.
//
//  Coverage for host-side media encryption and local peer classification.
//
...
#if os(macOS)
@Suite("Host Media Encryption")
struct HostMediaEncryptionTests {
    ...
    func clientDeclaredLocalOriginDoesNotDisableEncryptionForRemoteSessions() {
        ...
        #expect(
            host.mediaEncryptionEnabledForAcceptedSession(
