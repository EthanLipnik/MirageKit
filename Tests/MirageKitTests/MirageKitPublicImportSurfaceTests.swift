...
struct MirageKitPublicImportSurfaceTests {
    ...
    func ownerModuleImportsExposeCorePublicValueModels() throws {
        ...
        #expect(plan.totalDurationMs == 1_000)
        ...
        let captureCapability = MirageDiagnostics.MirageHostCaptureCapability(
            targetFrameRate: 120,
        ...
        let qualitySummary = MirageDiagnostics.MirageQualityTestSummary(
            ...
            hostEncodeMs: nil,
            clientDecodeMs: nil,
            hostCaptureCapability: captureCapability,
            stageResults: []
        )
        ...
        #expect(captureCapability.highestSustainedPixelCount == 8_294_400)
        #expect(qualitySummary.hostCaptureCapability == captureCapability)
