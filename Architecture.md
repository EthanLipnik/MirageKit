...
- post-resize recovery keeps keyframe-only decode admission armed until the first newly presented frame, and decode-error threshold recovery waits through a short post-resize grace window before requesting another recovery keyframe
